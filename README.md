# Moonriver Subsquid API

This is a sample project generated by `hydra-cli scaffold`. It allows one to create a graphql API which keeps track of all
token "minting" events and token "burning" events on the Moonriver network.
